...
public class ExamenObstetrico {
    ...
    private String maf;//movimientos activos fetales (SI o NO) options!
    private String observaciones;

    public ExamenObstetrico() {
    }

    public ExamenObstetrico(int talla, int peso, float imc, int au, int pa, int lcf, String maf, String observaciones) {
        this.talla = talla;
        this.peso = peso;
        this.imc = imc;
        this.au = au;
