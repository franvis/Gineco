...
public class ManejoArchivos {
    ...
    private static String db = "sistemacarla";
    private static String dia, mes, año, hora, minuto, segundo;
    
    public static boolean copiar(Component j, File destino){
        try {
            if(destino == null)
                return false;
            ...
            MensajesValidaciones.mostrarError(j, "Back up fallido para "+destino.getAbsolutePath()+e.getMessage());
            return false;
        }
        finally{
            try {           
