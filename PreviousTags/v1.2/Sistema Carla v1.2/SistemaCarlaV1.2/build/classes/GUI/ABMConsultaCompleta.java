...
public class ABMConsultaCompleta extends javax.swing.JDialog {
    ...
    public ABMConsultaCompleta(java.awt.Frame parent, boolean modal,int tipoConsulta,long dni) {
        ...
        else if(tipoConsulta == 0)
        {
            ...
            this.txtfDiagnostico.setNextFocusableComponent(this.txtfTalla);
        }
    ...
    private void initComponents() {
        ...
        txtaMamas.setFont(new java.awt.Font("Tahoma", 0, 13));
        ...
        txtaPapYColpo.setFont(new java.awt.Font("Tahoma", 0, 13));
        ...
        txtaGenitoUrinario.setFont(new java.awt.Font("Tahoma", 0, 13));
        ...
        txtaObstetObservaciones.setFont(new java.awt.Font("Tahoma", 0, 13));
        ...
        pnlMotivo.setFont(new java.awt.Font("Tahoma", 2, 12));

        txtaMotivo.setColumns(20);
        txtaMotivo.setFont(new java.awt.Font("Tahoma", 0, 13));
        ...
        lblstaticFecha.setFont(new java.awt.Font("Tahoma", 2, 12));
        lblstaticFecha.setForeground(new java.awt.Color(0, 51, 102));
        lblstaticFecha.setText("Fecha:");

        lblFecha.setFont(new java.awt.Font("Tahoma", 2, 12));
        ...
        pnlTratamiento.setFont(new java.awt.Font("Tahoma", 2, 12));

        txtaTratamiento.setColumns(20);
        txtaTratamiento.setFont(new java.awt.Font("Tahoma", 0, 13));
        ...
        pnlEstudiosComplementarios.setFont(new java.awt.Font("Tahoma", 2, 12));

        txtaEstudiosComple.setColumns(20);
        txtaEstudiosComple.setFont(new java.awt.Font("Tahoma", 0, 13));
        ...
        pnlObservaciones.setFont(new java.awt.Font("Tahoma", 2, 12));

        txtaObservaciones.setColumns(20);
        txtaObservaciones.setFont(new java.awt.Font("Tahoma", 0, 13));
        ...
        pnlObservaciones1.setFont(new java.awt.Font("Tahoma", 2, 12));

        txtfDiagnostico.setFont(new java.awt.Font("Tahoma", 0, 13));
        txtfDiagnostico.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 153, 153)));
        txtfDiagnostico.setNextFocusableComponent(txtaMamas);
        ...
        pnlObservaciones1Layout.setHorizontalGroup(
            ...
            .addComponent(txtfDiagnostico, javax.swing.GroupLayout.DEFAULT_SIZE, 392, Short.MAX_VALUE)
        );
        pnlObservaciones1Layout.setVerticalGroup(
            pnlObservaciones1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(txtfDiagnostico, javax.swing.GroupLayout.DEFAULT_SIZE, 32, Short.MAX_VALUE)
        );
        ...
        btnVolver.setFont(new java.awt.Font("Tahoma", 1, 12));
        ...
        pnlBotones1Layout.setHorizontalGroup(
            ...
            .addGroup(pnlBotones1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(btnVolver, javax.swing.GroupLayout.DEFAULT_SIZE, 111, Short.MAX_VALUE))
        );
