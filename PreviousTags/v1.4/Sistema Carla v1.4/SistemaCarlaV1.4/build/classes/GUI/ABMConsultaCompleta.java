...
public class ABMConsultaCompleta extends javax.swing.JDialog {
    ...
    private boolean banderaMensajeVolver;//false si estaba editando, presiona volver y no guardo;
    ...
    public ABMConsultaCompleta(java.awt.Frame parent, boolean modal,int tipoConsulta,long dni, Paciente paciente) {
        ...
        this.banderaMensajeVolver = false;
        ...
        if (parent.getExtendedState() == parent.MAXIMIZED_BOTH)
            this.setSize(new Dimension(this.getToolkit().getScreenSize().width - 50, this.getToolkit().getScreenSize().height - 57));
    ...
    public ABMConsultaCompleta(java.awt.Frame parent, boolean modal,int tipoConsulta,long dni, Paciente paciente, Consulta con) {
        ...
        this.banderaMensajeVolver = true;
        this.dni = dni;
        this.tipoConsulta = tipoConsulta;
        this.lblIMC.setText("");
    ...
    private void initComponents() {
                ...
                .addGroup(pnlObstetricoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlObstetricoLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlObstetricoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(lblIMC, javax.swing.GroupLayout.DEFAULT_SIZE, 81, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(pnlObstetricoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(pnlObstetricoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pnlObstetricoLayout.createSequentialGroup()
                                ...
                                .addGroup(pnlObstetricoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(pnlObstetricoLayout.createSequentialGroup()
                                        .addComponent(rbtnMafSi, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(rbtnMafNo, javax.swing.GroupLayout.DEFAULT_SIZE, 47, Short.MAX_VALUE))
                            ...
                            .addGroup(pnlObstetricoLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(lblstaticBarra, javax.swing.GroupLayout.PREFERRED_SIZE, 5, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        pnlFechaLayout.setHorizontalGroup(
            ...
            .addGroup(pnlFechaLayout.createSequentialGroup()
                .addGap(137, 137, 137)
                .addComponent(lblstaticFecha, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        pnlApellidoNombreLayout.setHorizontalGroup(
            ...
            .addGroup(pnlApellidoNombreLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblstaticNombre, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(lblNombrePaciente, javax.swing.GroupLayout.PREFERRED_SIZE, 237, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnVolverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVolverActionPerformed
        if(this.banderaMensajeVolver){
            this.dispose();
            HC.setVisible(true);
        }
        else
        {
        MensajesValidaciones.validarSalidaConsulta(this,HC);
        }
...
private void txtaDiagnosticoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtaDiagnosticoKeyTyped
// TODO add your handling code here:
}//GEN-LAST:event_txtaDiagnosticoKeyTyped
