...
public class MensajesValidaciones {
    ...
    /**
     * metodo para validar la salida del sistema mediante un mensaje desde una consulta
     * @param f Componente del mensaje
     */
    public static void validarSalidaConsulta(JDialog VentanaConsulta,JFrame HC){
        int ans = JOptionPane.showConfirmDialog(
                VentanaConsulta,
