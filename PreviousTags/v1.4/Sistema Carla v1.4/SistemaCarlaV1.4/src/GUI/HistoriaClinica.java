...
public class HistoriaClinica extends javax.swing.JFrame {
    ...
    private TableColumnModel clmColumnas;
    ...
    private void initComponents() {
        ...
        btnNuevaCompleta.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        btnNuevaGinecologica.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        btnNuevaObstetrica.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        btnGenerales.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        btnGinecologicos.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        btnFamiliares.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        pnlApellidoNombreLayout.setHorizontalGroup(
            ...
            .addGroup(pnlApellidoNombreLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(lblNombrePaciente, javax.swing.GroupLayout.DEFAULT_SIZE, 530, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    consultaCompleta = new ABMConsultaCompleta(this, false,2,paciente.getDni(), paciente);
    ...
    consultaCompleta = new ABMConsultaCompleta(this, false,1,paciente.getDni(), paciente);
    consultaCompleta.setTitle("Consulta Ginecologica");
    consultaCompleta.setVisible(true);
    ...
    consultaCompleta = new ABMConsultaCompleta(this, false,0,paciente.getDni(), paciente);
    consultaCompleta.setTitle("Consulta Obstetrica");
    consultaCompleta.setVisible(true);
    ...
    private void btnVerConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerConsultaActionPerformed
        ...
        consultaCompleta = new ABMConsultaCompleta(this, false,j,paciente.getDni(),paciente, c);
        consultaCompleta.setVisible(true);
    ...
    public void pintarHijos() {
        ...
        if(consultaCompleta != null)
            ClasesBase.GestorEstilos.pintar(consultaCompleta);
        if(antecedentesFamiliares != null)
            ClasesBase.GestorEstilos.pintar(antecedentesFamiliares);
        if(antecedentesGenerales != null)
            ClasesBase.GestorEstilos.pintar(antecedentesGenerales);
        if(antecedentesGinecologicos != null)
            ClasesBase.GestorEstilos.pintar(antecedentesGinecologicos);
    }
    }
