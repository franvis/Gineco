...
public class AntecGinecologicos extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        pnlGinecologicos.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(153, 153, 153), 1, true), "Antecedentes", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 13), new java.awt.Color(0, 51, 102))); // NOI18N
        ...
        lblstaticMenopausia.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        lblstaticSeparador2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        lblstaticSeparador3.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        lblstaticSeparador4.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        lblstaticSeparador5.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        pnlGinecologicosLayout.setHorizontalGroup(
            ...
            .addGroup(pnlGinecologicosLayout.createSequentialGroup()
                ...
                .addGroup(pnlGinecologicosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(lblstaticMenopausia, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                ...
                .addGroup(pnlGinecologicosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlGinecologicosLayout.createSequentialGroup()
                        .addGroup(pnlGinecologicosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtfMenopausia, javax.swing.GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(pnlGinecologicos, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void chkDispareuniaItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_chkDispareuniaItemStateChanged
        if (!btnGuardar.isEnabled())
            chkDispareunia.setSelected(paciente.getAntecGinec().isDispareunia());
        ...
        if (!btnGuardar.isEnabled()) 
            chkDismenorrea.setSelected(paciente.getAntecGinec().isDismenorrea());
    ...
    private void chkSdpmItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_chkSdpmItemStateChanged
        if (!btnGuardar.isEnabled()) 
            chkSdpm.setSelected(paciente.getAntecGinec().isSdpm());
    ...
    private void CambiarEstadoCajas(boolean accion)
    {
        ...
        this.txtfAbortos.setFocusable(accion);
        this.txtfAnticonceptivos.setFocusable(accion);
        this.txtfCesareas.setFocusable(accion);
        this.txtfDuracionMenstrual.setFocusable(accion);
        this.txtfPeriodoMenstrual.setFocusable(accion);
        this.txtfGestaciones.setFocusable(accion);
        this.txtfMenarca.setFocusable(accion);
        this.txtfMenopausia.setFocusable(accion);
        this.txtfPartos.setFocusable(accion);
        this.txtfTelarca.setFocusable(accion);
        this.txtfVivos.setFocusable(accion);
        this.txtfMuertos.setFocusable(accion);
        
        
        this.txtaGinecObserv.setEditable(accion);
        this.txtaGinecObserv.setEditable(accion);
        
        this.txtaGinecObserv.setFocusable(accion);
        this.txtaGinecObserv.setFocusable(accion);
        
        this.chkDismenorrea.setFocusable(accion);
        this.chkDispareunia.setFocusable(accion);
        this.chkSdpm.setFocusable(accion);
